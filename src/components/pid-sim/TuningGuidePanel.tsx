import { mantikLesson } from '@/config/external';
      ...
      <div className={`pid-guide-content ${tier === 'full' && highlightPulse ? 'aid-pulse' : ''}`}>
        ...
        {step.id === 'complete' && (
          <div className="pid-wizard-links">
            <a href={mantikLesson('/frc/pid-tuning-practice-setup')}>Full setup guide</a>
            <a
              href={
                mechanism === 'arm'
                  ? mantikLesson('/frc/pid-tuning-practice-arm')
                  : mechanism === 'flywheel'
                    ? mantikLesson('/frc/pid-tuning-practice-shooter')
                    : mantikLesson('/frc/pid-tuning-practice-elevator')
              }
            >
              {mechanism === 'arm'
                ? 'Arm tuning lesson'
