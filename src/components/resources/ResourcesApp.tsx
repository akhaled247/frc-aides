    ...
    <form className="resources-submit-form" onSubmit={handleSubmit}>
      ...
      {siteKey ? (
        ...
        <p className="resources-submit-note">
          Submissions require <code>PUBLIC_RECAPTCHA_SITE_KEY</code> in the GitHub Actions build
          environment.
        </p>
      )}
      ...
      {usingTestRecaptcha && import.meta.env.DEV && (
        <p className="resources-submit-note">
          Local dev: reCAPTCHA test key active. Production submit uses Mantik Netlify API.
        </p>
      )}
