...
export const CODE_TOUR_STEPS: CodeTourStep[] = [
  {
    ...
    learnMore: [{ label: 'Elevator example', href: 'https://mantik.netlify.app/frc/elevator-example' }],
  },
  {
    id: 'plant',
  ...
  },
  {
    ...
    learnMore: [{ label: 'PID Control', href: 'https://mantik.netlify.app/frc/frc-pid-control' }],
  },
  {
    id: 'feedforward',
    title: 'Feedforward',
    ...
    learnMore: [
      { label: 'PID Control — feedforward tuning', href: 'https://mantik.netlify.app/frc/frc-pid-control' },
      { label: 'Elevator tuning practice', href: 'https://mantik.netlify.app/frc/pid-tuning-practice-elevator' },
    ],
  },
  {
    id: 'setpoint',
    ...
    learnMore: [
      { label: 'Elevator tuning practice', href: 'https://mantik.netlify.app/frc/pid-tuning-practice-elevator' },
      { label: 'Binding Commands to Triggers', href: 'https://mantik.netlify.app/frc/robot-container-and-bindings' },
    ],
  },
  {
    id: 'limits',
    ...
    learnMore: [{ label: 'Trapezoidal motion profiling', href: 'https://mantik.netlify.app/frc/trapezoidal-motion-profiling' }],
  },
  {
    id: 'robot',
    ...
    learnMore: [
      { label: 'Introduction to motors — Robot.java lifecycle', href: 'https://mantik.netlify.app/frc/intro-to-motors' },
      ...
      { label: 'RobotContainer & Bindings', href: 'https://mantik.netlify.app/frc/robot-container-and-bindings' },
    ],
  },
  {
    id: 'elastic',
    ...
    learnMore: [{ label: 'Elastic basics', href: 'https://mantik.netlify.app/frc/elastic-basics' }],
  ...
  },
  {
    ...
    learnMore: [{ label: 'PID tuning practice setup', href: 'https://mantik.netlify.app/frc/pid-tuning-practice-setup' }],
  ...
  },
  {
    ...
    learnMore: [{ label: 'Elevator tuning practice', href: 'https://mantik.netlify.app/frc/pid-tuning-practice-elevator' }],
    advancePrerequisites: ['teleop'],
  },
];
