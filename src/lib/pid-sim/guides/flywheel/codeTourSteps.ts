...
export const FLYWHEEL_CODE_TOUR_STEPS: CodeTourStep[] = [
  {
    ...
    learnMore: [{ label: 'Shooter tuning practice', href: 'https://mantik.netlify.app/frc/pid-tuning-practice-shooter' }],
  },
  {
    id: 'plant',
  ...
  },
  {
    ...
    learnMore: [
      { label: 'Shooter tuning practice', href: 'https://mantik.netlify.app/frc/pid-tuning-practice-shooter' },
