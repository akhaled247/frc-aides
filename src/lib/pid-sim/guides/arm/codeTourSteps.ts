...
export const ARM_CODE_TOUR_STEPS: CodeTourStep[] = [
  {
    ...
    learnMore: [{ label: 'Arm tuning practice', href: 'https://mantik.netlify.app/frc/pid-tuning-practice-arm' }],
  },
  {
    id: 'plant',
  ...
  },
  {
    ...
    learnMore: [
      ...
      { label: 'Arm tuning practice', href: 'https://mantik.netlify.app/frc/pid-tuning-practice-arm' },
    ],
  },
  {
    id: 'setpoint',
